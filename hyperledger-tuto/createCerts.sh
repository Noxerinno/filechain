...
fabric-ca-client enroll --csr.names C=ES,ST=Madrid,L=Madrid,O=dummyOrg.com -m admin -u http://admin:adminpw@localhost:8054 

sleep 10

# Register admin identity and peer
fabric-ca-client register --id.name Admin@dummyOrg.com --id.secret mysecret --id.type client --id.affiliation org1 -u http://localhost:8054 

fabric-ca-client register --id.name peer0.dummyOrg.com --id.secret mysecret --id.type peer --id.affiliation org1 -u http://localhost:8054 
...
fabric-ca-client enroll --csr.names C=ES,ST=Madrid,L=Madrid,O=dummyOrg.com -m Admin@dummyOrg.com -u http://Admin@dummyOrg.com:mysecret@localhost:8054 
...
fabric-ca-client enroll --csr.names C=ES,ST=Madrid,L=Madrid,O=dummyOrg.com -m peer0.dummyOrg.com -u http://Admin@dummyOrg.com:mysecret@localhost:8054 
